...
})
{
  ...
  return (
    ...
    <Providers>
      ...
      {/* Footer */}
      {/* Discord Link: https://discord.gg/hkjAsTRz4a */}
      <footer className="footer p-10 bg-base-300 text-base-content">
        <nav>
          ...
          <Link href="https://discord.gg/hkjAsTRz4a">Join us on Discord</Link>
        </nav>
        {/*<nav>*/}
        ...
        <nav>
          ...
          <div className="grid grid-flow-col gap-4">
            <Link href="mailto:admin@write34.com">
              <svg width="30" height="30" viewBox="0 -2.5 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg">
